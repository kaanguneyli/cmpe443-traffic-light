...
uint32_t reset_matrix[8] = {0xFFFFFFFF,
							0xFFFFFFFF,
							0xFFFFFFFF,
							0xFFFFFFFF,
							0xFFFFFFFF,
...
uint32_t red_man[8] = {
		...
		0b00001000000100000000011111100000,
		0b00010010010010000001000000001000,
		0b00010000000010000001001001001000,
		0b00000111111000000000100000010000,
		0b00000101001000000000010000100000,
		0b00000111111000000000010010100000,
		0b00000000000000000000000000000000,
};


// frames 0-5-6-11
uint32_t green_man_1[8] = {
		0b00000000000000000000000000000000,
		0b00000111111000000000000000000000,
		0b00010000000010000000100000010000,
		0b00010001001010000001010010001000,
		0b00001000000100000001000000001000,
		0b00000100001000000000011111100000,
		0b00000100101000000000010100100000,
		0b00000000000000000000011111100000,
};

// frames 1-3-4
uint32_t green_man_2[8] = {
		0b00000000000000000000000000000000,
		0b00001000000100000000011111100000,
		0b00010001001010000001000000001000,
		0b00010000000010000001010010001000,
		0b00000111111000000000100000010000,
		0b00000100001000000000010000100000,
		0b00000010110000000000010000100000,
		0b00000000000000000000000111000000,
};

// frame 2
uint32_t green_man_3[8] = {
		0b00000111111000000000000000000000,
		0b00010000000010000000100000010000,
		0b00010001001010000001010010001000,
		0b00001000000100000001000000001000,
		0b00000100001000000000011111100000,
		0b00000100110000000000010000100000,
		0b00000001110000000000001001000000,
		0b00000000000000000000000000000000
};

// frames 7-8-10
uint32_t green_man_4[8] = {
		0b00000000000000000000000000000000,
		0b00001000000100000000011111100000,
		0b00010001001010000001000000001000,
		0b00010000000010000001010010001000,
		0b00000111111000000000100000010000,
		0b00000100001000000000010000100000,
		0b00001001101000000000010100100000,
		0b00000000000000000000011001110000,
};

// frame 9
uint32_t green_man_5[8] = {
		0b00000111111000000000000000000000,
		0b00010000000010000000100000010000,
		0b00010001001010000001010010001000,
		0b00001000000100000001000000001000,
		0b00000100001000000000011111100000,
		0b00000100100100000000010000100000,
		0b00001110001100000000101010010000,
		0b00000000000000000000000000000000
};
...
void changeLight(uint8_t color, uint8_t brightness) {
  int new_brightness = brightness & ~(0b11);
  new_brightness |= 1 << 2;
    ...
    if (((led >= 0 && led < 3) || (led >= 15 && led < 21) ||
      ...
      for (int bit = 23; bit >= 0; bit--) {
        ...
        i++;
               ...
               (color == GREEN)) {
      for (int bit = 23; bit >= 0; bit--) {
        if (bit >= 16 && ((new_brightness & (1 << (bit % 8))) != 0)) {
          animation_frame[i] = 13;
        } else {
          animation_frame[i] = 6;
        }
